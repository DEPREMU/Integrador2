...
const en: typeLanguages = {
  ...
  pdfFooterText1:
    "This report was automatically generated by the MediTime application.",
  pdfFooterText2:
    "For medical consultations, always consult with your healthcare professional.",
