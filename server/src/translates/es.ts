...
// Definición mínima local para backend
type typeLanguages = Record<string, string>;
...
export const es: typeLanguages = {
  ...
  hour: "Hora",
  hours: "Horas",
  // ...eliminadas claves no string para backend
  unknown: "Desconocido",
  ...
  medicationReminderBody: "Es hora de tu medicación.",
  testNotificationTitle: "Notificación de Prueba",
  testNotificationBody: "Esta es una notificación de prueba.",
};
